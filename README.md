...
<img width="651" height="502" alt="image" src="https://github.com/user-attachments/assets/261b81ad-aea0-4eb4-899d-115d295a7081" />
...
* **Gestión de Clientes:** Alta, baja y modificación de datos de usuarios.
* **Análisis de Consumo:** Gráficos detallados por tramos (Punta, Llano, Valle).
* **Generación de Facturas:** Exportación automática a PDF.
* **Base de Datos Local:** Segura y sin necesidad de conexión a internet.

## 💻 Requisitos del Sistema
Para garantizar un rendimiento óptimo, el equipo debe cumplir con los siguientes requisitos:
